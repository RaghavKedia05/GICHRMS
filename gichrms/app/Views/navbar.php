        ...
        <div class="relative z-[110]">
            ...
            <div id="settingsMenu"
                ...
                <div class="p-2">
                    ...
                    <a id="replayProductTour" href="<?= base_url('dashboard?tour=replay') ?>" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-indigo-50 hover:text-indigo-700">
