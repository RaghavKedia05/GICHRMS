...
<aside id="sidebar" data-tour="sidebar" class="fixed inset-y-0 left-0 z-50 flex h-screen w-[272px] -translate-x-full flex-col border-r border-slate-200 bg-white shadow-2xl transition-transform duration-300 lg:static lg:w-[248px] lg:translate-x-0 lg:shadow-none">
